...
🚀 [Finish setting up your workspace](https://cloud.nx.app/connect/Q89j4kvC4j) to get faster builds with remote caching, distributed task execution, and self-healing CI. [Learn more about Nx Cloud](https://nx.dev/ci/intro/why-nx-cloud).
## Generate a library
